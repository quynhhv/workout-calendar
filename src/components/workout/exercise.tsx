...
const ExerciseComponent: React.FC<ExerciseProps> = ({ exercise }) => {
  return (
    <div className="flex flex-col border border-[#DFDFDF] rounded-lg px-2 pb-1 pt-0 mb-[4px] bg-background shadow-sm">
      <p className=" text-lg text-right font-semibold truncate text-[13px] ml-3">{exercise.name}</p>
